(function (global, factory) {
  ...
  var getParentElement = function (domElement) { return domElement.select(function () {
  ...
  function milestones(selector) {
    ...
    function render(data) {
      ...
      var groupMerge = groupEnter
        .merge(group)
        .style(marginTimeAttribute, function (d) { return x(aggregateFormatParse(d.key)) + 'px'; });
      ...
      if (useLabels) {
        ...
        var labelMerge = label
          ...
          //   );
          // })
          .classed(cssAboveClass + '-' + orientation, function (d) { return isAbove(d.index, distribution); }
          );
      ...
      timelineMerge.each(function (d, i, node) {
        ...
        var maxAboveHeight = max(
          select(node[i]).selectAll('* .' + cssAboveClass + '-' + orientation)
            ._groups[0],
          function (d) { return d.offsetHeight; }
        );
